...
date: 2020-03-31T11:41:08+01:00
...
This is an abstraction of the Mbientlab Metawear API
...
<br>Method to make the blutooth connection with the MetaMotion sensor. It includes some
necessary initialization for the library, like create instance sensors and subscribe 
the battery value in order to be able to query it. Also, check that the model of the
sensor that we are connection is the properly (MetaMotionR)
...
### <span class="api-func">`init_sensors`</span>

```py
def init_sensors(self)
```

<br>Init the sensors of the MetaMotionR device
